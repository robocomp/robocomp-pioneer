...
REGISTER_NODE_TYPE(plant)
REGISTER_NODE_TYPE(microwave)
REGISTER_NODE_TYPE(oven)
REGISTER_NODE_TYPE(vase)
REGISTER_NODE_TYPE(refrigerator)
REGISTER_NODE_TYPE(book)
REGISTER_NODE_TYPE(bottle)
REGISTER_NODE_TYPE(fork)
