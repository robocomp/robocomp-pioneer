...
/** \mainpage RoboComp::laser_integrator
 *
 * \section intro_sec Introduction
 *
 * The laser_integrator component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/laser_integrator --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class laser_integrator : public RoboComp::Application
{
public:
	laser_integrator (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::laser_integrator::initialize()
{
...
int ::laser_integrator::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	tprx = std::make_tuple(laser_proxy,laser1_proxy);
...
int main(int argc, char* argv[])
{
	...
	::laser_integrator app(prefix, startup_check_flag);
