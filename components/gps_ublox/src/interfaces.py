...
Ice.loadSlice("-I ./src/ --all ./src/MonitorBase.ice")
import RoboCompMonitorBase
...
class Publishes:
    def __init__(self, ice_connector, topic_manager):
        ...
        self.gpsublox = self.create_topic("GpsUblox", RoboCompGpsUblox.GpsUbloxPrx)
...
class Implements:
    def __init__(self, ice_connector, default_handler):
        self.ice_connector = ice_connector
        self.gpsublox = self.create_adapter("GpsUblox", gpsubloxI.GpsUbloxI(default_handler))
        self.monitorbase = self.create_adapter("MonitorBase", monitorbaseI.MonitorBaseI(default_handler))
