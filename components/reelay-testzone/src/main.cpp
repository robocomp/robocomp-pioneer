...
/** \mainpage RoboComp::reelay_testzone
 *
 * \section intro_sec Introduction
 *
 * The reelay_testzone component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/reelay_testzone --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class reelay_testzone : public RoboComp::Application
{
public:
	reelay_testzone (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::reelay_testzone::initialize()
{
...
int ::reelay_testzone::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::reelay_testzone app(prefix, startup_check_flag);
